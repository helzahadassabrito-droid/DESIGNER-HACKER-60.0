...
export const SectionOne: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      mm.add("(min-width: 768px)", () => {
          tl.fromTo(logoRef.current, 
            { 
                ...
                opacity: 0,
                scale: 1.4,
                filter: 'hue-rotate(90deg)' // Expensive
            },
            { 
      ...
      // Pulsing Scroll Indicator (Optimized: y translate is cheap)
