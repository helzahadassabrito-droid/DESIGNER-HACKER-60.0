    ...
    return (
        <footer className="relative w-full py-16 bg-[#050505] border-t border-white/5 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="flex items-center gap-8 md:gap-10 mb-8">
                {/* Behance */}
                <a href="#" className="text-white hover:opacity-80 transition-opacity duration-300 transform hover:scale-110" aria-label="Behance">
                    <img src="/behance-2-logo-png-transparent.svg" alt="Behance" className="w-6 h-6 md:w-7 md:h-7" />
                </a>
