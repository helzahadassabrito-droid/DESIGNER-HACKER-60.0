...
const PremiumTiltCard = () => {
    ...
    return (
        ...
        >
            ...
            {/* Main Image - Explicit Size to prevent CLS */}
            <img 
    ...
    >
      ...
      >
        ...
        <div className="relative w-full min-h-[100dvh] flex flex-col items-center bg-black">
            ...
            <div 
                ref={marqueeRef} 
                className="absolute top-0 left-0 w-full bg-[#FC2C54] z-20 overflow-hidden py-1.5 md:py-2 opacity-0 shadow-[0_5px_20px_rgba(252,44,84,0.3)]"
            >
            ...
            <div ref={contentRef} className="relative z-10 w-full max-w-6xl mx-auto px-4 pt-10 md:pt-20 pb-12 flex flex-col items-center text-center flex-grow justify-center">
                ...
                {/* Logo & Headline */}
                <div ref={headlineRef} className="opacity-0 flex flex-col items-center mb-2 mt-0 md:mb-6 md:mt-4 shrink-0">
                    <img 
                ...
                {/* Subheadline */}
                <h2 ref={subRef} className="opacity-0 text-xl md:text-2xl lg:text-3xl text-white font-bold mb-6 md:mb-8 max-w-4xl shrink-0 font-sans leading-relaxed">
                ...
                <div ref={cardsRef} className="w-full grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8 shrink-0 max-w-4xl">
                    ...
                    {/* Card 1 */}
                    <div className="opacity-0 h-full group">
                ...
                {/* Trust Stars */}
                <div ref={trustRef} className="opacity-0 flex flex-col items-center gap-2 shrink-0 mt-6 md:mt-8">
        ...
        {/* ==========================================
            SEPARATOR
           ========================================== */}
        <div ref={arrowRef} className="relative w-full flex items-center justify-center py-0 bg-transparent z-30 -mt-12 md:-mt-16 -mb-8 md:mb-0 pointer-events-none opacity-0">
            ...
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col">
                ...
                <div className="flex flex-col items-center w-full mt-0 mb-8">
                    ...
                    <div className="relative w-screen left-1/2 -translate-x-1/2 overflow-hidden h-[100px] md:h-[120px] flex items-center">
                         ...
                         {/* MOBILE OPTIMIZATION: Hidden gradients to prevent overdraw on mobile */}
                         <div 
                            className="absolute left-0 top-0 h-full w-[150px] md:w-[250px] pointer-events-none z-10 hidden md:block"
                         ...
                         {/* MOBILE OPTIMIZATION: Hidden gradients to prevent overdraw on mobile */}
                         <div 
                            className="absolute right-0 top-0 h-full w-[150px] md:w-[250px] pointer-events-none z-10 hidden md:block"
