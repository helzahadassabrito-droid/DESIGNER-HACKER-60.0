        ...
        >
            ...
            <div className="absolute inset-0 w-full h-full">
                ...
                */}
                ...
                {/* Label Render - Removed backdrop-blur on mobile, increased opacity */}
                <div className="absolute top-6 right-6 bg-black/80 md:bg-black/60 md:backdrop-blur-md px-4 py-1 rounded-full border border-white/10 text-white text-xs font-bold tracking-widest uppercase shadow-md">
                    Render Final
                </div>
            </div>
            ...
            >
                <img 
                    ...
                    decoding="async"
                />
                 {/* Label Sketch - Removed backdrop-blur on mobile */}
                 <div className="absolute top-6 left-6 bg-white/90 md:bg-white/10 md:backdrop-blur-sm px-4 py-1 rounded-full border border-black/20 text-black text-xs font-bold tracking-widest uppercase shadow-md">
                    Sketch
                </div>
            </div>
            ...
            <div className="relative w-full md:w-[65%] aspect-[16/10] bg-[#F5F5F5] rounded-xl overflow-hidden shadow-lg md:shadow-2xl group border border-white/10">
                ...
                <div className="w-full h-full flex items-center justify-center p-8">
                     <img 
                        ...
                        alt="Variation" 
                        className="w-[90%] h-auto object-contain drop-shadow-2xl transition-transform duration-500 group-hover:scale-105 will-change-transform"
                        loading="lazy"
                        decoding="async"
                     />
                </div>
                ...
                <div className="absolute bottom-4 left-4 flex gap-2 p-2 bg-white/90 md:bg-white/50 md:backdrop-blur-md rounded-lg shadow-sm">
